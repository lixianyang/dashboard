...
import (
	...
	"github.com/kubernetes/dashboard/v2/src/app/backend/cert"
	...
	"github.com/kubernetes/dashboard/v2/src/app/backend/handler"
...
func handleFatalInitError(err error) {
	log.Fatalf("Error while initializing connection to Kubernetes apiserver. "+
		...
		"https://github.com/kubernetes/dashboard/v2/wiki/FAQ", err)
}
