...
import (
	...
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/networkpolicy"

	"github.com/kubernetes/dashboard/v2/src/app/backend/handler/parser"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/customresourcedefinition/types"

	"github.com/kubernetes/dashboard/v2/src/app/backend/plugin"
	...
	"github.com/kubernetes/dashboard/v2/src/app/backend/auth"
	...
	"github.com/kubernetes/dashboard/v2/src/app/backend/integration"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/clusterrole"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/clusterrolebinding"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/common"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/configmap"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/container"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/controller"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/cronjob"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/customresourcedefinition"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/daemonset"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/dataselect"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/deployment"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/event"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/horizontalpodautoscaler"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/ingress"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/job"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/logs"
	ns "github.com/kubernetes/dashboard/v2/src/app/backend/resource/namespace"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/node"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/persistentvolume"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/persistentvolumeclaim"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/pod"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/replicaset"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/replicationcontroller"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/role"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/rolebinding"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/secret"
	resourceService "github.com/kubernetes/dashboard/v2/src/app/backend/resource/service"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/serviceaccount"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/statefulset"
	"github.com/kubernetes/dashboard/v2/src/app/backend/resource/storageclass"
	"github.com/kubernetes/dashboard/v2/src/app/backend/scaling"
	"github.com/kubernetes/dashboard/v2/src/app/backend/settings"
	settingsApi "github.com/kubernetes/dashboard/v2/src/app/backend/settings/api"
	"github.com/kubernetes/dashboard/v2/src/app/backend/systembanner"
	"github.com/kubernetes/dashboard/v2/src/app/backend/validation"
)
