...
import (
	...
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/networkpolicy"

	"github.com/lixianyang/dashboard/v2/src/app/backend/handler/parser"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/customresourcedefinition/types"

	"github.com/lixianyang/dashboard/v2/src/app/backend/plugin"
	...
	"github.com/lixianyang/dashboard/v2/src/app/backend/auth"
	authApi "github.com/lixianyang/dashboard/v2/src/app/backend/auth/api"
	clientapi "github.com/lixianyang/dashboard/v2/src/app/backend/client/api"
	"github.com/lixianyang/dashboard/v2/src/app/backend/errors"
	"github.com/lixianyang/dashboard/v2/src/app/backend/integration"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/clusterrole"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/clusterrolebinding"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/common"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/configmap"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/container"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/controller"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/cronjob"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/customresourcedefinition"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/daemonset"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/dataselect"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/deployment"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/event"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/horizontalpodautoscaler"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/ingress"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/job"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/logs"
	ns "github.com/lixianyang/dashboard/v2/src/app/backend/resource/namespace"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/node"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/persistentvolume"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/persistentvolumeclaim"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/pod"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/replicaset"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/replicationcontroller"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/role"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/rolebinding"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/secret"
	resourceService "github.com/lixianyang/dashboard/v2/src/app/backend/resource/service"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/serviceaccount"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/statefulset"
	"github.com/lixianyang/dashboard/v2/src/app/backend/resource/storageclass"
	"github.com/lixianyang/dashboard/v2/src/app/backend/scaling"
	"github.com/lixianyang/dashboard/v2/src/app/backend/settings"
	settingsApi "github.com/lixianyang/dashboard/v2/src/app/backend/settings/api"
	"github.com/lixianyang/dashboard/v2/src/app/backend/systembanner"
	"github.com/lixianyang/dashboard/v2/src/app/backend/validation"
)
